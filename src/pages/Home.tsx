  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-background to-background/50">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          <div className="text-center space-y-8">
            ...
            <div className="max-w-2xl mx-auto">
              {!showUploader ? <Card className="bg-gradient-card shadow-elevated border-0 hover:shadow-glow transition-all duration-500">
                  ...
                  <CardContent>
                    <Button size="lg" className="w-full h-14 text-lg font-semibold bg-gradient-primary hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-xl" onClick={() => setShowUploader(true)}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feature, index) => <Card key={index} className="group bg-gradient-card border-0 shadow-card hover:shadow-elevated transition-all duration-500 hover:-translate-y-2" style={{
      ...
      <div className="bg-muted/20 py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          }].map((process, index) => <div key={index} className="text-center group">
